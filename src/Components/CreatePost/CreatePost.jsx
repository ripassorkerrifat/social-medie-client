  ...
  return (
    <div className="createPost p-4">
      <div className="top-section flex w-full">
        ...
        "
          placeholder="What's on your main, Ripas Sorker?"
        />
      </div>
      <hr className="border-b border-gray-400 mt-3 opacity-60" />
      <div className="bottom-section flex items-center justify-between mx-4 mt-3">
        <div className="flex items-center">
          <TbVideoPlus className="inline-block text-3xl text-[#ff059b]" />
          <span className="inline-block font-semibold ml-2 ">Live Video</span>
        </div>
        <div className="flex items-center">
          <FaPhotoVideo className="inline-block text-3xl text-green-500" />
          <span className="inline-block font-semibold ml-2 ">Photo/Video</span>
        </div>
        <div className="flex items-center">
          <GrEmoji className="inline-block text-3xl text-yellow-500" />
