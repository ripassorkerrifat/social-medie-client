   ...
   return (
      <div className="navContainer">
         <div className="leftside">
            <Link
               to={"/"}
               className="font-semibold text-[#a624d1] lg:text-3xl md:text-2xl text-xl md:px-6 px-2 py-2"
            >
         ...
         <div className="center hidden md:inline-block">
            <div className=" relative w-[90%] m-auto">
               <input
                  type="text"
                  className=" form-control block rounded-2xl w-full px-9 md:py-1.5 text-base font-normal text-gray-700 bg-gray-100 hover:bg-gray-200 bg-clip-padding border border-solid border-gray-300 transition ease-in-out m-0 focus:text-gray-700 focus:outline-none
        "
